...
# Shortlink Info
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://upshrink.com')
...
MULTI_CLIENT = False
name = str(environ.get('name', 'HKBOTSBot'))
...
if HAS_SSL:
    URL = "https://themovieproviderbot-9hnn.onrender.com/".format(FQDN)
else:
    URL = "https://themovieproviderbot-9hnn.onrender.com/".format(FQDN)
